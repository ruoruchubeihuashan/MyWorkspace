...
public class DFReader {
	...
	private static void tag22(String table, String family, String selectFields) {
		List<BasicTagBean> tag = new ArrayList<BasicTagBean>() {{
			add(new BasicTagBean() {{setId(132);setName("超高");}});
			add(new BasicTagBean() {{setId(133);setName("高");}});
			add(new BasicTagBean() {{setId(134);setName("中上");}});
			add(new BasicTagBean() {{setId(135);setName("中");}});
			add(new BasicTagBean() {{setId(136);setName("中下");}});
			add(new BasicTagBean() {{setId(137);setName("低");}});
			add(new BasicTagBean() {{setId(138);setName("很低");}});
		}};
