	...
	public static void main(String[] args) throws IOException {
		HBaseUtil hBaseV1011Template = new HBaseUtil();
		 ...
		 Map<String, Map<String, String>> keyValues = new HashMap<String, Map<String, String>>(){{
			 put("2_haier",(Map)new HashMap<String,String>(){{put("name","liupw");}});
			 put("3_haier",(Map)new HashMap<String,String>(){{put("name","zymichelle");}});
			 put("4_haier",(Map)new HashMap<String,String>(){{put("name","chinadgfy");}});
			 put("5_haier",(Map)new HashMap<String,String>(){{put("name","383421028");}});
			 put("6_haier",(Map)new HashMap<String,String>(){{put("name","ctt_65");}});
			 put("7_haier",(Map)new HashMap<String,String>(){{put("name","jimmy");}});
			 put("8_haier",(Map)new HashMap<String,String>(){{put("name","liyang79");}});
			 put("9_haier",(Map)new HashMap<String,String>(){{put("name","cindirila");}});
			 put("10_haier",(Map)new HashMap<String,String>(){{put("name","498883342");}});
			 put("11_haier",(Map)new HashMap<String,String>(){{put("name","陈龙平");}});
			 put("12_haier",(Map)new HashMap<String,String>(){{put("name","ruinajiaxing");}});
			 put("13_haier",(Map)new HashMap<String,String>(){{put("name","sngmdito");}});
			 put("14_haier",(Map)new HashMap<String,String>(){{put("name","44858603@qq.com");}});
			 put("15_haier",(Map)new HashMap<String,String>(){{put("name","2899999@qq.com");}});
			 put("16_haier",(Map)new HashMap<String,String>(){{put("name","32310367@qq.com");}});
			 put("17_haier",(Map)new HashMap<String,String>(){{put("name","1231231211@qq.com");}});
			 put("18_haier",(Map)new HashMap<String,String>(){{put("name","179769200@qq.com");}});
			 put("19_haier",(Map)new HashMap<String,String>(){{put("name","179769202@qq.com");}});
			 put("20_haier",(Map)new HashMap<String,String>(){{put("name","1234567@qq.com");}});
			 put("21_haier",(Map)new HashMap<String,String>(){{put("name","307840758@qq.com");}});
			 put("22_haier",(Map)new HashMap<String,String>(){{put("name","1464152022@qq.com");}});
			 put("23_haier",(Map)new HashMap<String,String>(){{put("name","788889878@qq.com");}});
			 put("24_haier",(Map)new HashMap<String,String>(){{put("name","8899999999");}});
			 put("25_haier",(Map)new HashMap<String,String>(){{put("name","13242134@qq.com");}});
			 put("26_haier",(Map)new HashMap<String,String>(){{put("name","402642697@qq.com");}});
			 put("27_haier",(Map)new HashMap<String,String>(){{put("name","464439931@qq.com");}});
			 put("28_haier",(Map)new HashMap<String,String>(){{put("name","23445232@qq.com");}});
			 put("29_haier",(Map)new HashMap<String,String>(){{put("name","2131237@qq.com");}});
			 put("30_haier",(Map)new HashMap<String,String>(){{put("name","981869175@qq.com");}});
			 put("31_haier",(Map)new HashMap<String,String>(){{put("name","814775297@qq.com");}});
			 put("32_haier",(Map)new HashMap<String,String>(){{put("name","141234124@qq.com");}});
			 put("33_haier",(Map)new HashMap<String,String>(){{put("name","4123125@qq.com");}});
			 put("34_haier",(Map)new HashMap<String,String>(){{put("name","41231225@qq.com");}});
			 put("35_haier",(Map)new HashMap<String,String>(){{put("name","3252162343@qq.com");}});
			 put("36_haier",(Map)new HashMap<String,String>(){{put("name","4151231@qq.com");}});
			 put("37_haier",(Map)new HashMap<String,String>(){{put("name","415123132@qq.com");}});
			 put("38_haier",(Map)new HashMap<String,String>(){{put("name","1412523423@qq.com");}});
			 put("39_haier",(Map)new HashMap<String,String>(){{put("name","132453532@qq.com");}});
			 put("40_haier",(Map)new HashMap<String,String>(){{put("name","125214452@qq.com");}});
			 put("41_haier",(Map)new HashMap<String,String>(){{put("name","1252144252@qq.com");}});
			 put("42_haier",(Map)new HashMap<String,String>(){{put("name","124124124@qq.com");}});
			 put("43_haier",(Map)new HashMap<String,String>(){{put("name","124124122@qq.com");}});
			 put("44_haier",(Map)new HashMap<String,String>(){{put("name","242352332@qq.com");}});
			 put("45_haier",(Map)new HashMap<String,String>(){{put("name","18560683520");}});
			 put("46_haier",(Map)new HashMap<String,String>(){{put("name","464439930@qq.com");}});
			 put("47_haier",(Map)new HashMap<String,String>(){{put("name","464439932@qq.com");}});
			 put("48_haier",(Map)new HashMap<String,String>(){{put("name","123456123@qq.com");}});
			 put("49_haier",(Map)new HashMap<String,String>(){{put("name","133185212@qq.com");}});
			 put("50_haier",(Map)new HashMap<String,String>(){{put("name","1451231231@qq.com");}});
			 put("51_haier",(Map)new HashMap<String,String>(){{put("name","12451313@qq.com");}});
			 put("52_haier",(Map)new HashMap<String,String>(){{put("name","1512312512@qq.com");}});
			 put("53_haier",(Map)new HashMap<String,String>(){{put("name","2451231362@qq.com");}});
			 put("54_haier",(Map)new HashMap<String,String>(){{put("name","1254123125@qq.com");}});
			 put("55_haier",(Map)new HashMap<String,String>(){{put("name","1451231@qq.com");}});
			 put("56_haier",(Map)new HashMap<String,String>(){{put("name","241512312@qq.com");}});
			 put("57_haier",(Map)new HashMap<String,String>(){{put("name","1235123523@qq.com");}});
			 put("58_haier",(Map)new HashMap<String,String>(){{put("name","2514511231@qq.com");}});
			 put("59_haier",(Map)new HashMap<String,String>(){{put("name","2145132342@qq.com");}});
			 put("60_haier",(Map)new HashMap<String,String>(){{put("name","1351254@qq.com");}});
			 put("61_haier",(Map)new HashMap<String,String>(){{put("name","1231412313@qq.com");}});
			 put("62_haier",(Map)new HashMap<String,String>(){{put("name","1254123123@qq.com");}});
			 put("63_haier",(Map)new HashMap<String,String>(){{put("name","12345141@qq.com");}});
			 put("64_haier",(Map)new HashMap<String,String>(){{put("name","12415133@qq.com");}});
			 put("65_haier",(Map)new HashMap<String,String>(){{put("name","2135154121@qq.com");}});
			 put("66_haier",(Map)new HashMap<String,String>(){{put("name","14536722@qq.com");}});
			 put("67_haier",(Map)new HashMap<String,String>(){{put("name","235723546@qq.com");}});
			 put("68_haier",(Map)new HashMap<String,String>(){{put("name","3215526242@qq.com");}});
			 put("69_haier",(Map)new HashMap<String,String>(){{put("name","1245123213@qq.com");}});
			 put("70_haier",(Map)new HashMap<String,String>(){{put("name","415161313@qq.com");}});
			 put("71_haier",(Map)new HashMap<String,String>(){{put("name","2451235131@qq.com");}});
			 put("72_haier",(Map)new HashMap<String,String>(){{put("name","12234341@qq.com");}});
			 put("73_haier",(Map)new HashMap<String,String>(){{put("name","1234123131@qq.com");}});
		 }};
