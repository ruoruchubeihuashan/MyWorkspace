                                            ...
                                            <table id = "failtable" class="table table-striped table-bordered table-hover table-text-center" >
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="resale" data-toggle="modal" data-target="#popermodal">开发</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
        ...
        <div class="modal fade" id="popermodal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="instruction_upload" style="color: red;">*请开发人员自行到指定路径补完算法逻辑，再行启用该标签算法算法存储路径：http://192.168.0.0/123/234/789</div>
