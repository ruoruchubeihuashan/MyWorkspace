            ...
            <div class="leftNav">
                <div class="con_gr">
                  <div class="left_gr">
                        ...
                        <div class="firstGr" style="transition: 0.5s;position: relative;">
                            <img src="${basePath}/res/imgs/71.png">
                            <span value=${var1.id} title=${var1.name}><a href="${basePath}/examine/page/examine">审批管理</a></span>
                        </div>
                        <div class="firstGr" style="transition: 0.5s;position: relative;">
                            <img src="${basePath}/res/imgs/71.png">
                            <span value=${var1.id} title=${var1.name}><a href="${basePath}/examine/page/develop">开发管理</a></span>
                        </div>
                        <div class="firstGr" style="transition: 0.5s;position: relative;">
                            <img src="${basePath}/res/imgs/71.png">
                            <span value=${var1.id} title=${var1.name}><a href="${basePath}/examine/page/release">发布管理</a></span>
                        </div>
                  </div>
                </div>                
            </div>
                            ...
                            <div class="User_centerIN_tubiao current_table" >
                                ...
                                <section class="table_wrap clearfix all-table-container">
                                    <div class="cover_style">
                                        <!--用户列表失败-->
                                        <div>
                                            <table id = "failtable" class="table table-striped table-bordered table-hover table-text-center" >
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="resale"><span class="look_msg" data-toggle="modal" data-target="#popermodal">查看</span> <span class="cancel_shen">取消</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="text-align:center;">
                        <button id="createchildrentype" type="button" class="btn btn-primary execute" data-dismiss="modal">
                            确定
                        </button>
                    </div>
                </div>
