                        ...
                        <div class="admin_left_top">
                            ...
                            <@shiro.hasRole name="supper_admin">  
					           <div class="admin_left_top_img">
	                                ...
	                                <span id="addOrg" class="admin_left_top_add" data-toggle="modal" data-target="#institutionModal"><span class="addIcon">+</span>添加</span>
	                            </div>
					        </@shiro.hasRole> 
                        </div>
                       ...
                       <div class="admin_left_userlist" style="height: 555px;">
                            ...
                            <div class="list_item_div">
                                <div class="companyName">
                                    <span class="company group" style="background:url(${basePath}/res/imgs/u62.png) no-repeat 0 10px !important;padding-left: 17px;" value=${var1.id} title=${var1.name}>${var1.name}</span>
                                ...
                                <div class="companyChild">
	                                ...
	                                <div class="childItem">
	                                	<#if var2.children>
	                                    <span class="group" data-flag="0" style="background:url(${basePath}/res/imgs/u62.png) no-repeat 0 10px !important;padding-left: 17px;" value=${var2.id} title=${var2.name} style="padding-left: 30px;">${var2.name}</span>
	                                    <#else>
	                                    <span class="group" data-flag="1" value=${var2.id} title=${var2.name}>${var2.name}</span>
	                                    </#if>
	                                ...
	                                <div class="groupChild">
		                                ...
		                                <div class="childItems">
		                                    <span class="group" data-sta="3" value=${var3.id} title=${var3.name} style="padding-left: 30px;">${var3.name}</span>
		                                    <!-- <span class="delchild">X</span> -->
		                                </div>
		                                </#list>
	                                </div>                                
                             ...
                             <@shiro.hasAnyRoles name="supper_admin,admin">  
		                        <section class="admin_middle_import" style="float:right;">
	                                 <div class="import_add">
	                                     ...
	                                     <span class="add_btn"    data-toggle="modal" data-target="#userlistModal"><span class="addIcon">+</span>添加用户</span>
	                                 </div>
	                            </section>
		                     </@shiro.hasAnyRoles>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body addrolemodel_sp">
                        <div>
                            ...
                            <input maxlength="10" type="text" placeholder="最多可输入10个字符" class="addrolemodel_input"></input>
                        </div>
                        <div>
                            <span class="tip"></span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <span class="tip">*</span>
                            <span  class="addrolemodel_span">角色名称：</span>
                            <input id="rolename_input" maxlength="10" type="text" placeholder="最多可输入10个字符" class="editrolemodel_input"></input>
                        </div>
                        <div>
                            <span class="tip"></span>
                            <span  class="addrolemodel_span">角色描述：</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <span class="tip">*</span>
                            <span  class="addrolemodel_span">角色名称：</span>
                            <input type="text" name="makeupCo" required = "true"  class="addrolemodel_input makeup" readonly />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <input type="text" name="makeupCo" maxlength="20" placeholder="最多可输入20个字符" id = "company_name" class="addrolemodel_input makeup"/>
                        </div>
                    </div>
                    <div class="modal-footer" style="text-align:center;">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <input type="text" name="makeupCo" maxlength="20"  placeholder="最多可输入20个字符" id = "nextGroupName" class="addrolemodel_input makeup"/> 
                        </div>  
                    </div>
                    <div class="modal-footer" style="text-align:center;">
                    ...
                    <div class="modal-body">
                        <form action="" id="addUsermanageForm" class="">
                            ...
                            <div>
                                ...
                                <input id="add_username" maxlength="20" type="text"  placeholder="最多可输入20个字符" class="addrolemodel_input addUserInput user_username" name="user_username">
                            </div>  
                            <div>
                                <span class="tip">*</span>
                                <span  class="addrolemodel_span">密码：</span>
                                <input id="add_password" minlength="6" maxlength="18" type="password"  placeholder="可输入6-18个字符"  class="addrolemodel_input addUserInput user_password" name="user_password">
                            </div>
                            <div>
                                <span class="tip">*</span>
                                <span  class="addrolemodel_span">姓名：</span>
                                <input id="add_name" maxlength="10" type="text"  placeholder="最多可输入10个字符" class="addrolemodel_input addUserInput user_name" name="user_name">
                            </div>  
                            <div>
                                <span class="tip"></span>
                                <span  class="addrolemodel_span">邮箱：</span>
                                <input id="add_email" type="text"class="addrolemodel_input addUserInput user_useremail" name="user_useremail">
                            </div>  
                            <div>
                                <span class="tip">*</span>
                                <span  class="addrolemodel_span">手机号码：</span>
                                <input id="add_userphone" maxlength="11" type="text" class="addrolemodel_input addUserInput user_userphone" name="user_userphone">
                            </div>  
                            <div>
                                <span class="tip">*</span>
                ...
                <div class="modal-content">
                    ...
                    <div  class="modal-body">
                        <div style="position: relative;">
                            ...
                            <input type="text" readonly="" style="height: 30px;border:1px solid #ccc;" class="typename_input" />
                    ...
                    <div class="modal-body">
                        <form action="" class="usermanageForm">
                            <div>
                                <span class="tip">*</span>
                                <span  class="addrolemodel_span">用户名：</span>
                                <input id="edit_userName" maxlength="20" type="text" id="edit_userName" placeholder="最多可输入20个字符" class="addrolemodel_input addUserInput user_username" name="user_username">
                            </div>  
                            <div>
                                <span class="tip">*</span>
                                <span  class="addrolemodel_span">姓名：</span>
                                <input maxlength="10" type="text" id="edit_adminName" placeholder="最多可输入10个字符" class="addrolemodel_input addUserInput user_name" name="user_name">
                            </div>  
                            <div>
                                <span class="tip"></span>
                                <span  class="addrolemodel_span">邮箱：</span>
                                <input type="text" id="edit_admin_email" class="addrolemodel_input addUserInput user_useremail" name="user_useremail">
                            </div>  
                            <div>
                                <span class="tip">*</span>
                                <span  class="addrolemodel_span">手机号码：</span>
                                <input id="edit_admin_phoneNumber" maxlength="11" type="text" class="addrolemodel_input addUserInput user_userphone" name="user_userphone">
                            </div>  
                            <div>
                                <span class="tip">*</span>
                                <span class="typename_datatype">角色分配：</span>
