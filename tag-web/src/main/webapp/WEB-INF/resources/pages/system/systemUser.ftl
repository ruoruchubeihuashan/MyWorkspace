        ...
        <div class="cont_right_label_wrap" style="margin-left: 19px; width: 97%; ">
            ...
            <form action="" class="usermessage">
                ...
                <div class="form_data">
                    ...
                    <input id="username"  type="text" name="username" class="addlabel_name_input" value="${user.username}" placeholder="最多可输入20个字符" maxlength="20">
                </div>
                <div class="form_data">
                    <span class="addlabel_user"><span class="tip">*</span>姓名：</span>
                    <input id="user" type="text" name="name" class="addlabel_user_input" value="${user.name}" placeholder="最多可输入10个字符" maxlength="10">
                </div>
                <div class="form_data">
                ...
                <div class="form_data">
                    ...
                    <input id="phonenumber"  type="text" name="phone" class="addlabel_phone_input" value="${user.phone}" placeholder="最多可输入11个字符" maxlength="11">
                </div>
                <div class="btnsbox">
