                  ...
                  <div id="leftList" class="left_gr" >
                        ...
                        <#list basicTagList as levelOne>
	                        ...
	                        <div style="display:block;" class="zi" style="background-color: rgb(66, 74, 81);">
		                        <div class="secondGr">
		                        	<span class="second_img" style="background:url(${basePath}/res/imgs/left_s2.png) no-repeat 0 10px !important;" value=${levelTwo.id} level=${levelTwo.level} title=${levelTwo.name}>${levelTwo.name}</span>
		                        </div>
	                            <div class="secondzi">
	                             ...
	                             <!-- 三级标签 -->
	                              <div class="we">
	                                <div class="we_div">
	                                	<span class="we_div_span" value=${levelThree.id} level=${levelThree.level} title=${levelThree.name} style="background:url(${basePath}/res/imgs/left_s2.png) no-repeat 0 10px !important;">${levelThree.name}</span>
	                                </div>
	                              </div>
	                              <div class="fourth">
		                             ...
		                             <!-- 四级标签 -->
		                              <div class="four">
		                                <div class="four_div">
		                                	<span class="four_div_span" value=${levelFourth.id} level=${levelFourth.level} title=${levelFourth.name}>${levelFourth.name}</span>
		                                </div>
		                              </div>
		                              </#list>
		                          </div>
            ...
            <div class="label_cont">
                <div class="label_cont_top clearfix">
                    ...
                    <div id="breadDiv" class="nav_second" style="float: left;">
                      <span id="label_level1" class="label_cont_top_l label_cont_top_l1" value="${basicTagList[0].id}`${basicTagList[0].level}" title=${basicTagList[0].name}>${basicTagList[0].name}</span>
                      <span class="label_nav_sp2">></span>
                      <span id="label_level2" class="label_cont_top_l label_cont_top_l2" value="${basicTagList[0].subTags[0].id}`${basicTagList[0].subTags[0].level}" title=${basicTagList[0].subTags[0].name}>${basicTagList[0].subTags[0].name}</span>
                      <span class="label_nav_sp2">></span>
                      <span id="label_level3" class="label_cont_top_l label_cont_top_l3" value="${basicTagList[0].subTags[0].subTags[0].id}`${basicTagList[0].subTags[0].subTags[0].level}" title=${basicTagList[0].subTags[0].subTags[0].name}>${basicTagList[0].subTags[0].subTags[0].name}</span>
                    </div>
