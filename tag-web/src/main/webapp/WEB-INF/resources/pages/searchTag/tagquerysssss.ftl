       ...
       <div class="centent_box">
            ...
            <div class="choice">
                ...
                <div class="choicebox">
                    ...
                    <dl class="twocontent">
                        <dt><p>二级：</p><div class="selStr2"></div></dt>
                        <dd><img src="${basePath}/res/imgs/55.png" class="del"></dd>
                    </dl>
                    <dl class="threecontent">
                        <dt><p>三级：</p><div class="selStr3"></div></dt>
                        <dd><img src="${basePath}/res/imgs/55.png" class="del"></dd>
                    </dl>
                    <dl class="fourcontent">
                        <dt><p>四级：</p><div class="selStr4"></div></dt>
                        <dd><img src="${basePath}/res/imgs/55.png" class="del"></dd>
                    </dl>
                    <dl class="fivecontent">
                        <dt><p>五级：</p><div class="selStr5"></div></dt>
                        <dd><img src="${basePath}/res/imgs/55.png" class="del"></dd>
                    </dl>
                </div>
            </div>
        ...
        <div class="User_center">
            <div id="User_centerIN" class="User_centerIN">
                <div class="User_centerIN_top1">
                    ...
                    <div class="choicebox">
                        <dl class="onecontent">
                            <dt><p>一级：</p><div class="selStr1"></div></dt>
                        </dl>
                        <dl class="twocontent">
                            <dt><p>二级：</p><div class="selStr2"></div></dt>
                        </dl>
